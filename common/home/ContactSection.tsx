      ...
      <div className="w-full max-w-[808px]">
        ...
        {sent ? (
          <div className="text-center py-16 flex flex-col items-center gap-5">
            <div className="flex h-16 w-16 items-center justify-center rounded-full border border-[#164962] bg-[#08101F]">
            ...
            <div>
              ...
              <p className="text-white/40 text-sm mt-1">Your mail client has opened. I&apos;ll reply soon.</p>
            </div>
            <button onClick={() => setSent(false)}
              className="text-sm text-[#2f62ff] hover:text-[#3d73ff] underline underline-offset-4 transition-colors">

      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="mb-14 text-center">
          ...
          <h2 className="mt-4 text-3xl font-extrabold tracking-tight text-white sm:text-4xl lg:text-5xl">
            Architecting <span className="bg-gradient-to-r from-cyan-400 via-violet-400 to-pink-400 bg-clip-text text-transparent">Digital Experiences</span>
          </h2>
        ...
        <div className="grid gap-10 lg:grid-cols-12 lg:items-center">
          {/* Left Column: Portrait Image & Quick Stats Card */}
              ...
              >
                ...
                <div className="mt-4 grid grid-cols-2 gap-2.5">
                  {quickStats.map((stat) => (
                    <div
                      key={stat.label}
                      className="rounded-2xl border border-white/5 bg-white/5 p-3 text-center backdrop-blur-md transition duration-300 hover:border-white/15"
                    >
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            >
              ...
              <p className="mt-4 text-sm leading-7 text-white/70 sm:text-base">
                I holds a Bachelor&apos;s degree in Computer Science & Engineering from <strong className="text-white font-semibold">Green University of Bangladesh</strong>. My passion lies in building meaningful, user-centered applications using <span className="text-cyan-300 font-medium">React, Next.js, Node.js, Express, MongoDB, and TypeScript</span>.
              </p>
              <p className="mt-3 text-sm leading-7 text-white/65 sm:text-base">
                I combine technical rigor with clean architecture and maintainable code bases, ensuring every project balances performance, security, and exceptional user experience.
              </p>
            </NoiseCard>
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              {highlights.map((item) => (
                <NoiseCard
                  key={item.title}
                  className="rounded-2xl border border-white/8 p-5 transition duration-300 hover:-translate-y-1 hover:border-white/20"
